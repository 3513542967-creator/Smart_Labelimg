...
def test_main_window_uses_sam_for_assisted_boxes_without_text_auto_detect(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(app_module, "MOBILE_SAM_ENCODER", tmp_path / "missing-encoder.onnx")
    monkeypatch.setattr(app_module, "MOBILE_SAM_DECODER", tmp_path / "missing-decoder.onnx")
